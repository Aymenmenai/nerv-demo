...
const HeadSection = () => {
  ...
  const data = ["Lower engery ?", "Open the can","Free, Smooth, Energy ,Power, Neurv"];
  return (
    <Page>
      <div className={`${open ? "bg-yellow-300" : ""} flex-col w-full h-full flex justify-center items-center `}>
